...
export default function Page() {
  ...
  useEffect(() => {
    const savedCards: string | null = localStorage.getItem("savedCards");
    if (savedCards) {
  ...
  function handleAddCard() {
    ...
    //figure out how to do this with typescript
    // interface SectionType {
    //     applied | phonescreen | technical | takehome | panel | offer | rejected
    // }
  ...
  const sectionCountHeader: {[key: string]: number} = (section) => {
        
        const sectionCountObj = Object.values(addCardInfo).reduce(
        // double check what these types are 
        (sectionCount: any, card: any) => {
